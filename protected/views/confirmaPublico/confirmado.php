...
<div class="yiiForm">
	...
	<table class="dataGrid">
		...
		<tr>
			...
			<td><?php echo $form->inscricao->concurso->conc_nome .' - <b>Realização:</b> '. CHtml::encode(Yii::app()->dateFormatter->format('dd/MM/yyyy',$form->inscricao->concurso->conc_data_realizacao)); ?></td>
		</tr>

		<tr>
			<th class="label" style="text-align: right;"><?php echo CHtml::activeLabel($form,'instituicao'); ?>:</th>
			<td><?php echo $form->inscricao->instituicao->inst_nome; ?></td>
		</tr>

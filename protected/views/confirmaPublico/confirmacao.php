...
<div class="yiiForm">
	...
	<table class="dataGrid">
		...
		<tr>
    		...
    		<td><?php echo CHtml::activeTextField($form->colaborador,'colab_nome',array('size' => 44, 'maxlength' => 60)); ?></td>
		</tr>

		<tr>
			<th class="label" style="text-align: right;">CPF:</th>
    		<td><?php echo $form->colaborador->colab_cpf; ?></td>
		</tr>
		...
		<tr>
    		...
    		<td><?php echo CHtml::activeTextField($form->colaborador, 'colab_email', array('size' => 44, 'maxlength' => 60)); ?></td>
		</tr>
		...
		<tr>
    		...
    		<td><?php echo CHtml::activeTextField($form->colaborador,'colab_rg',array('size' => 20, 'maxlength' => 20)); ?></td>
		</tr>

		<tr>
			<th class="label" style="text-align: right;">Banco:</th>
    		<td><?php echo CHtml::activeDropDownList($form->colaborador, 'colab_banco_id', 
		...
		<tr>
			...
			<td><?php echo CHtml::activeTextField($form->colaborador, 'colab_conta', array('size' => 19, 'maxlength' => 19)); ?></td>
		</tr>

		<tr>
			<th class="label" style="text-align: right;">Dígito da Conta:</th>
			<td><?php echo CHtml::activeTextField($form->colaborador, 'colab_conta_dv', array('size' => 1, 'maxlength' => 1)); ?></td>
		</tr>
	...
	<p><?php echo CHtml::activeCheckBox($form, 'ciente'); ?> Declaro que meus dados estão corretos e, ainda, que:
		<ul>
			<li>Estou ciente da nova data de realização do concurso: ;</li>

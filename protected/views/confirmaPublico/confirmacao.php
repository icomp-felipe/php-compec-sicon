...
<div class="yiiForm">
	...
	<p><?php echo CHtml::activeCheckBox($form, 'ciente'); ?> Declaro que meus dados estão corretos e, ainda, que:
		<ul>
			<li>Estou ciente da nova data de realização do <?php echo $form->inscricao->concurso->conc_nome ?> → <?php echo Yii::app()->dateFormatter->format('dd/MM/yyyy',$form->inscricao->concurso->conc_data_realizacao); ?>;</li>

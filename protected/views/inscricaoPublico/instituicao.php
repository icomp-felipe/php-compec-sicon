...
<h3 class="actionBar">
	<ul>
		...
		<li><?php echo $form->concurso->conc_nome .' - Realização: '. CHtml::encode(Yii::app()->dateFormatter->format('dd/MM/yyyy',$form->concurso->conc_data_realizacao)).' ['.CHtml::link('Trocar]',array('selecionarConcurso')); ?></li>

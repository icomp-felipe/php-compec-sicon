...
class InscricaoController extends CController
{
	...
	{
		$this->render('show',array('model'=>$this->loadinscricao()));
	}
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['inscricao']))
		{
			...
			if($model->save())
				$this->redirect(array('show','id'=>$model->idinscricao));
		}
	...
	public function actionList()
	{
		...
		$pages=new CPagination(inscricao::model()->count($criteria));
		$pages->pageSize=self::PAGE_SIZE;
		$pages->applyLimit($criteria);

		$models=inscricao::model()->findAll($criteria);
